...
if x == "hiphop":
    notes = []
    counter = 0
    for file in glob.glob("C:\\Users\\Dell\\Downloads\\generation 2\\hiphopnew\\*.mid"):
...
#-------------------piano----------------------------------            
    ...
    notes = []
    counter = 0
    for file in glob.glob("C:\\Users\\Dell\\Downloads\\generation 2\\piano\\*.mid"):
...
#-------------------pop----------------------------------             
    ...
    notes = []
    counter = 0
    for file in glob.glob("C:\\Users\\Dell\\Downloads\\generation 2\\pop\\*.mid"):
...
#-------------------j-pop----------------------------------           
    ...
    notes = []
    counter = 0
    for file in glob.glob("C:\\Users\\Dell\\Downloads\\generation 2\\j-pop\\*.mid"):
...
#-------------------beethoven----------------------------------            
    ...
    notes = []
    counter = 0
    for file in glob.glob("C:\\Users\\Dell\\Downloads\\generation 2\\weights-beethoven new we.hdf5\\*.mid"):
...
#-------------------chopin----------------------------------             
    ...
    notes = []
    counter = 0
    for file in glob.glob("C:\\Users\\Dell\\Downloads\\generation 2\\chopin\\*.mid"):
...
#-------------------pokemon----------------------------------           
    ...
    notes = []
    counter = 0
    for file in glob.glob("C:\\Users\\Dell\\Downloads\\generation 2\\Pokemon MIDIs\\*.mid"):
